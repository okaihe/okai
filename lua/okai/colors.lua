local colors = {
    ...
    DiagnosticSignError = { fg = '#CE3B3B', bg = '#0a0a12' },
    DiagnosticFloatingError = { link = 'DiagnosticSignError' },
    DiagnosticSignHint = { fg = '#FFDF9E', bg = '#0a0a12' },
    DiagnosticFloatingHint = { link = 'DiagnosticSignHint' },
    DiagnosticSignInfo = { fg = '#CCE5FF', bg = '#0a0a12' },
    DiagnosticFloatingInfo = { link = 'DiagnosticSignInfo' },
    DiagnosticSignOk = { fg = '#B1D9AB', bg = '#0a0a12' },
    DiagnosticFloatingOk = { link = 'DiagnosticSignOk' },
    DiagnosticSignWarn = { fg = '#D9AE6D', bg = '#0a0a12' },
    DiagnosticFloatingWarn = { link = 'DiagnosticSignWarn' },
    DiagnosticWarn = { fg = '#D9AE6D', bg = '#1C212C' },
    DiagnosticVirtualTextWarn = { link = 'DiagnosticWarn' },
    DiffAdd = { fg = '#E5C07B', bg = '#0a0a12' },
    DiffChange = { fg = '#C2E0FF', bg = '#0a0a12' },
    DiffDelete = { fg = '#CE3B3B', bg = '#0a0a12' },
    ...
    LineNr = { fg = '#D9AE6D', bg = '#0a0a12', italic = true },
    LineNrAbove = { fg = '#2B2B4F', bg = '#0a0a12' },
    LineNrBelow = { fg = '#2B2B4F', bg = '#0a0a12' },
    LspCodeLens = {},
    ...
    ModeMsg = {},
    MoreMsg = {},
    MsgArea = { fg = '#EDE1D4', bg = '#0a0a12' },
    MsgSeparator = {},
    NonText = {},
    NormalFloat = { fg = '#4DEAFF', bg = '#0a0a12' },
    ...
    TelescopePreviewTitle = { fg = '#0a0a12', bg = '#D9AE6D' },
    TelescopePromptBorder = { fg = '#252B3C', bg = '#252B3C' },
    TelescopePromptNormal = { bg = '#252B3C' },
    TelescopePromptPrefix = { fg = '#B1D9AB' },
    TelescopePromptTitle = { fg = '#0a0a12', bg = '#D9AE6D' },
    TelescopeResultsTitle = { fg = '#0a0a12', bg = '#D9AE6D' },
    TelescopeSelection = { fg = '#EDE1D4', bg = '#252B3C' },
    TelescopeSelectionCaret = { link = 'TelescopeSelection' },
    TermCursor = { fg = '#0a0a12', bg = '#EDE1D4' },
    TermCursorNC = { fg = '#0a0a12', bg = '#090910' },
