local colors = {
    ...
    CmpItemAbbrDeprecated = { fg = '#667685', strikethrough = true },
    ...
    ColorColumn = { bg = '#21272B' },
    Comment = { fg = '#728392', italic = true },
    ...
    CursorColumn = {},
    CursorIM = {},
    CursorLine = { bg = '#21272B' },
    CursorLineNr = { fg = '#E5A315', bold = true },
    DiagnosticError = { fg = '#CE3B3B', bg = '#21272B' },
    DiagnosticUnderlineError = { link = 'DiagnosticError' },
    DiagnosticVirtualTextError = { link = 'DiagnosticError' },
    DiagnosticHint = { fg = '#FFDF9E', bg = '#21272B' },
    DiagnosticVirtualTextHint = { link = 'DiagnosticHint' },
    DiagnosticInfo = { fg = '#CCE5FF', bg = '#21272B' },
    DiagnosticVirtualTextInfo = { link = 'DiagnosticInfo' },
    DiagnosticOk = { fg = '#B1D9AB', bg = '#21272B' },
    DiagnosticVirtualTextOk = { link = 'DiagnosticOk' },
    DiagnosticSignError = { fg = '#CE3B3B', bg = '#161A1D' },
    DiagnosticFloatingError = { link = 'DiagnosticSignError' },
    DiagnosticSignHint = { fg = '#FFDF9E', bg = '#161A1D' },
    DiagnosticFloatingHint = { link = 'DiagnosticSignHint' },
    DiagnosticSignInfo = { fg = '#CCE5FF', bg = '#161A1D' },
    DiagnosticFloatingInfo = { link = 'DiagnosticSignInfo' },
    DiagnosticSignOk = { fg = '#B1D9AB', bg = '#161A1D' },
    DiagnosticFloatingOk = { link = 'DiagnosticSignOk' },
    DiagnosticSignWarn = { fg = '#EFBF57', bg = '#161A1D' },
    DiagnosticFloatingWarn = { link = 'DiagnosticSignWarn' },
    DiagnosticWarn = { fg = '#EFBF57', bg = '#21272B' },
    DiagnosticVirtualTextWarn = { link = 'DiagnosticWarn' },
    DiffAdd = { fg = '#A0D199', bg = '#161A1D' },
    DiffChange = { fg = '#C2E0FF', bg = '#161A1D' },
    DiffDelete = { fg = '#CE3B3B', bg = '#161A1D' },
    Directory = { fg = '#A3D1FF', bold = true },
    EndOfBuffer = { fg = '#161A1D' },
    ErrorMsg = { fg = '#D86464' },
    FloatBorder = {},
    FloatTitle = {},
    ...
    IblIndent = { fg = '#2A3137' },
    IblScope = { fg = '#8C9AA6' },
    IblWhitespace = { fg = '#5D6C79' },
    Identifier = { fg = '#6CA4F9' },
    Keyword = { fg = '#F4AD66', bold = true },
    LineNr = { fg = '#E5A315', bg = '#161A1D', bold = true },
    LineNrAbove = { fg = '#525F6B', bg = '#161A1D' },
    LineNrBelow = { fg = '#525F6B', bg = '#161A1D' },
    LspCodeLens = {},
    ...
    MatchParen = { fg = '#E5A315', bg = '#525F6B' },
    ModeMsg = {},
    MoreMsg = {},
    MsgArea = { fg = '#EDE1D4', bg = '#161A1D' },
    MsgSeparator = {},
    NonText = {},
    NormalFloat = { fg = '#4AC6D3', bg = '#161A1D' },
    Pmenu = { fg = '#97A4AF', bg = '#23292E' },
    ...
    PmenuThumb = { bg = '#667685' },
    PreProc = { fg = '#B1D9AB' },
    Question = {},
    QuickFixLine = {},
    Search = { fg = '#161A1D', bg = '#ADD6FF' },
    CurSearch = { link = 'Search' },
    IncSearch = { link = 'Search' },
    Substitute = { link = 'Search' },
    CursorLineSign = { link = 'SignColumn' },
    Special = { fg = '#E5A315' },
    SpecialKey = { fg = '#3E4851' },
    Statement = { fg = '#E5A315' },
    StatusLine = { bg = '#1F2428' },
    StatusLineNC = { bg = '#161A1D' },
    String = { fg = '#74BE8A' },
    TabLine = {},
    TabLineFill = {},
    TabLineSel = {},
    ...
    TelescopePreviewTitle = { fg = '#161A1D', bg = '#B1D9AB' },
    TelescopePromptBorder = { fg = '#101313', bg = '#101313' },
    TelescopePromptNormal = { bg = '#101313' },
    TelescopePromptPrefix = { fg = '#B1D9AB' },
    TelescopePromptTitle = { fg = '#161A1D', bg = '#B1D9AB' },
    TelescopeResultsTitle = { fg = '#161A1D', bg = '#B1D9AB' },
    TelescopeSelection = { fg = '#EDE1D4', bg = '#101313' },
    TelescopeSelectionCaret = { link = 'TelescopeSelection' },
    TermCursor = { fg = '#161A1D', bg = '#EDE1D4' },
    TermCursorNC = { fg = '#161A1D', bg = '#161A1D' },
    ...
    WinBar = {},
    WinBarNC = {},
    Winseparator = { fg = '#2A3137' },
    diffAdded = { fg = '#5FB253' },
    diffLine = { fg = '#525F6B', bold = true },
    ...
    ['@text.todo'] = { fg = '#4AC6D3', bg = '#3E4851', bold = true },
